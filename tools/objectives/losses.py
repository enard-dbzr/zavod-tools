...
class NormalizedCovarianceWindowLoss(PredictionBasedMetric):
    def __init__(self, cov_adapter: Callable[[torch.Tensor], torch.Tensor],
        ...
        :arg vanish_xx: Определяет, будет ли обнуляться срез матрицы, соответствующий ковариациям X на X.
        :arg vanish_xy: Определяет, будет ли обнуляться срез матрицы, соответствующий ковариациям X на Y.
        :arg vanish_yy: Определяет, будет ли обнуляться срез матрицы, соответствующий ковариациям Y на Y.
